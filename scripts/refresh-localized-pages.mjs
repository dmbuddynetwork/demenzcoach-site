...
for (const { code } of languages) {
  ...
  html = html.replace('href="styles.css"', 'href="lovable-home.css?v=20260908f"');
  html = html.replace(/href="lovable-home\.css(?:\?v=[^"]+)?"/, 'href="lovable-home.css?v=20260908f"');
  html = html.replace('src="script.js"', 'src="lovable-home.js"');
  html = html.replace(/src="lovable-home\.js(?:\?v=[^"]+)?"/, 'src="lovable-home.js?v=20260908f"');
